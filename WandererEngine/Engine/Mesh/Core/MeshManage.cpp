...
CMeshComponent* CMeshManage::CreateCustomMeshComponent(string& InPath)
{
...
CMeshComponent* CMeshManage::CreateConeMeshComponent(float InBottomRadius, float InHeight, uint32_t InAxialSubdivision, uint32_t InHeightSubdivision)
{
    return CreateMeshComponent<CConeMeshComponent>(InBottomRadius, InHeight, InAxialSubdivision, InHeightSubdivision);
}
