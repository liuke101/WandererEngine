...
void CConeMeshComponent::CreateMesh(FMeshRenderingData& MeshData, float InBottomRadius, float InHeight, uint32_t InAxialSubdivision, uint32_t InHeightSubdivision)
{
    ...
    // 【构建顶点】
    // 锥点
    MeshData.VertexData.push_back(FVertex(XMFLOAT3(0.0f, 0.5f * InHeight, 0.0f), XMFLOAT4(Colors::White)));
